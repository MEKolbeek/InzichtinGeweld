...
# Functie om een specifieke datum (incidentdatum) te extraheren
...
pdf_path = r"C:\\Users\\mkolb\\Documents\\ECLI_NL_RBROT_2010_BN3932.pdf"
incident_date = extract_incident_date(pdf_path)
print("Incidentdatum:", incident_date)
